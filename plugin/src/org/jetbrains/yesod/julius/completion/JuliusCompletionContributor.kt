...
class JuliusCompletionContributor : CompletionContributor() {
    ...
    companion object {
        ...
        var KEYWORDS: List<String> = Arrays.asList(
        ...
        var AJAX_SETTINGS: List<String> = Arrays.asList(
        ...
        var AJAX_FUNCTIONS: List<String> = Arrays.asList(
        ...
        var JS_FUNCTIONS: List<String> = Arrays.asList(
