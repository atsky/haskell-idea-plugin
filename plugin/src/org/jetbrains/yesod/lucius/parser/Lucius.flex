...
[A-Za-z_-]+                               { return LuciusTokenTypes.IDENTIFIER; }
"."[A-Za-z_-]+                            { return LuciusTokenTypes.DOT_IDENTIFIER; }
"#"[A-Za-z0-9_-]+                         { return LuciusTokenTypes.SHARP_IDENTIFIER; }
"@"[A-Za-z0-9_-]+("."[A-Za-z0-9_-]+)?     { return LuciusTokenTypes.AT_IDENTIFIER; }
":"[A-Za-z0-9_-]+                         { return LuciusTokenTypes.COLON_IDENTIFIER; }
"::"[A-Za-z0-9_-]+                        { return LuciusTokenTypes.CC_IDENTIFIER; }
"http://"[A-Za-z0-9:./-_]+                { return LuciusTokenTypes.HYPERLINK; }
"https://"[A-Za-z0-9:./-_]+               { return LuciusTokenTypes.HYPERLINK; }
"ftp://"[A-Za-z0-9:./-_]+                 { return LuciusTokenTypes.HYPERLINK; }
"ftps://"[A-Za-z0-9:./-_]+                { return LuciusTokenTypes.HYPERLINK; }
