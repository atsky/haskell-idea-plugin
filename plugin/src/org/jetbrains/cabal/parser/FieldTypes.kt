...
public val PROPERTY_FIELD_TYPES: Map<String, IElementType> = mapOf(
         ...
         "subdir"               to CabalTokelTypes.REPO_SUBDIR       ,
         "extra-lib-dirs"       to CabalTokelTypes.EXTRA_LIB_DIRS    ,
         "includes"             to CabalTokelTypes.INCLUDES          ,
         "install-includes"     to CabalTokelTypes.INSTALL_INCLUDES  ,
         "data-files"           to CabalTokelTypes.DATA_FILES        ,
