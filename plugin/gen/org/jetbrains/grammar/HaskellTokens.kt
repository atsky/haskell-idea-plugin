...
object HaskellTokens {
  ...
  val RULES = HaskellCompositeElementType("rules")
  val RULE = HaskellCompositeElementType("rule")
  val RULE_ACTIVATION = HaskellCompositeElementType("rule_activation")
  val RULE_EXPLICIT_ACTIVATION = HaskellCompositeElementType("rule_explicit_activation")
  val RULE_FORALL = HaskellCompositeElementType("rule_forall")
  val RULE_VAR_LIST = HaskellCompositeElementType("rule_var_list")
  val RULE_VAR = HaskellCompositeElementType("rule_var")
  val WARNINGS = HaskellCompositeElementType("warnings")
  val WARNING = HaskellCompositeElementType("warning")
  val DEPRECATIONS = HaskellCompositeElementType("deprecations")
  val DEPRECATION = HaskellCompositeElementType("deprecation")
  val STRINGS = HaskellCompositeElementType("strings")
  val STRINGLIST = HaskellCompositeElementType("stringlist")
  val ANNOTATION = HaskellCompositeElementType("annotation")
  val FDECL = HaskellCompositeElementType("fdecl")
  val CALLCONV = HaskellCompositeElementType("callconv")
  val SAFETY = HaskellCompositeElementType("safety")
  val FSPEC = HaskellCompositeElementType("fspec")
  ...
  val TEXP = HaskellCompositeElementType("texp")
  val TUP_EXPRS = HaskellCompositeElementType("tup_exprs")
  val COMMAS_TUP_TAIL = HaskellCompositeElementType("commas_tup_tail")
  val TUP_TAIL = HaskellCompositeElementType("tup_tail")
  val LIST = HaskellCompositeElementType("list")
  val LEXPS = HaskellCompositeElementType("lexps")
  val FLATTENEDPQUALS = HaskellCompositeElementType("flattenedpquals")
  val PQUALS = HaskellCompositeElementType("pquals")
  val SQUALS = HaskellCompositeElementType("squals")
  val TRANSFORMQUAL = HaskellCompositeElementType("transformqual")
  val PARR = HaskellCompositeElementType("parr")
  val GUARDQUALS = HaskellCompositeElementType("guardquals")
  val GUARDQUALS1 = HaskellCompositeElementType("guardquals1")
  val ALTSLIST = HaskellCompositeElementType("altslist")
  val ALTS = HaskellCompositeElementType("alts")
  val ALTS1 = HaskellCompositeElementType("alts1")
  val ALT = HaskellCompositeElementType("alt")
  val ALT_RHS = HaskellCompositeElementType("alt_rhs")
  val RALT = HaskellCompositeElementType("ralt")
  val GDPATS = HaskellCompositeElementType("gdpats")
  val GDPATSSEMI = HaskellCompositeElementType("gdpatssemi")
  val IFGDPATS = HaskellCompositeElementType("ifgdpats")
  val GDPAT = HaskellCompositeElementType("gdpat")
  val PAT = HaskellCompositeElementType("pat")
  val BINDPAT = HaskellCompositeElementType("bindpat")
  val APAT = HaskellCompositeElementType("apat")
  val APATS = HaskellCompositeElementType("apats")
  val STMTLIST = HaskellCompositeElementType("stmtlist")
  val STMTS = HaskellCompositeElementType("stmts")
  val STMTS_HELP = HaskellCompositeElementType("stmts_help")
  val MAYBE_STMT = HaskellCompositeElementType("maybe_stmt")
  val STMT = HaskellCompositeElementType("stmt")
  val QUAL = HaskellCompositeElementType("qual")
  val FBINDS = HaskellCompositeElementType("fbinds")
  val FBINDS1 = HaskellCompositeElementType("fbinds1")
  val FBIND = HaskellCompositeElementType("fbind")
  ...
  val NAME_BOOLFORMULA_OPT = HaskellCompositeElementType("name_boolformula_opt")
  val NAME_BOOLFORMULA = HaskellCompositeElementType("name_boolformula")
  val NAME_BOOLFORMULA_AND = HaskellCompositeElementType("name_boolformula_and")
  val NAME_BOOLFORMULA_ATOM = HaskellCompositeElementType("name_boolformula_atom")
  val NAMELIST = HaskellCompositeElementType("namelist")
  val NAME_VAR = HaskellCompositeElementType("name_var")
  val QCON = HaskellCompositeElementType("qcon")
  val CON = HaskellCompositeElementType("con")
  val CON_LIST = HaskellCompositeElementType("con_list")
  val SYSDCON = HaskellCompositeElementType("sysdcon")
  val CONOP = HaskellCompositeElementType("conop")
  val QCONOP = HaskellCompositeElementType("qconop")
  ...
  val QCONID = HaskellCompositeElementType("qconid")
  val CONID = HaskellCompositeElementType("conid")
  val QCONSYM = HaskellCompositeElementType("qconsym")
  val CONSYM = HaskellCompositeElementType("consym")
